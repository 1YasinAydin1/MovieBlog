<%@ Page Title="" Language="C#" MasterPageFile="~/client/client.Master" AutoEventWireup="true" CodeBehind="typeDetail.aspx.cs" Inherits="Asp.Net_Entity_.client.typeDetail" %>
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <asp:Repeater ID="Repeater2" runat="server">
        <ItemTemplate>
              <h4 class="ml-3" style="color:#4a5054;"><%# Eval("typeName") %></h4>
            <hr class="mb-4" />
        </ItemTemplate>
    </asp:Repeater>
